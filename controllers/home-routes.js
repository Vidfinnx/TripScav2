...
//Starts us on homepage by default
router.get("/highres", (req, res) => {
  res.render("highres", { username: req.session.username,
    loggedIn: req.session.loggedIn,
  });
});

router.get("/lowres", (req, res) => {
  res.render("lowres", { username: req.session.username,
    loggedIn: req.session.loggedIn,
  });
});
...
router.get("/script",withAuth, (req, res) => {
  res.render("script", { username: req.session.username,
    loggedIn: req.session.loggedIn
  }
  );
});
